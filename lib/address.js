...
function Address (bluffmaster) {
  ...
  this.cityPrefix = function () {
    return bluffmaster.random.arrayElement(bluffmaster.definitions.address.city_prefix);
  }
  ...
  this.citySuffix = function () {
    return bluffmaster.random.arrayElement(bluffmaster.definitions.address.city_suffix);
  }
  ...
  this.cityName = function() {
    return bluffmaster.random.arrayElement(bluffmaster.definitions.address.city_name);
  }
  ...
  this.streetAddress = function (useFullAddress) {
    ...
    switch (bluffmaster.datatype.number(2)) {
      case 0:
        address = Helpers.replaceSymbolWithNumber("#####") + " " + bluffmaster.address.streetName();
        break;
      case 1:
        address = Helpers.replaceSymbolWithNumber("####") +  " " + bluffmaster.address.streetName();
        break;
    ...
    return useFullAddress ? (address + " " + bluffmaster.address.secondaryAddress()) : address;
  }
  ...
  this.streetSuffix = function () {
    return bluffmaster.random.arrayElement(bluffmaster.definitions.address.street_suffix);
  }
  ...
  this.streetPrefix = function () {
    return bluffmaster.random.arrayElement(bluffmaster.definitions.address.street_prefix);
  }
  ...
  this.secondaryAddress = function () {
    return Helpers.replaceSymbolWithNumber(bluffmaster.random.arrayElement(
      [
        'Apt. ###',
        'Suite ###'
      ]
  ...
  this.county = function () {
    return bluffmaster.random.arrayElement(bluffmaster.definitions.address.county);
  }
  ...
  this.country = function () {
    return bluffmaster.random.arrayElement(bluffmaster.definitions.address.country);
  }
  ...
  this.countryCode = function (alphaCode) {
    ...
    if (typeof alphaCode === 'undefined' || alphaCode === 'alpha-2') {
      return bluffmaster.random.arrayElement(bluffmaster.definitions.address.country_code);
    }

    if (alphaCode === 'alpha-3') {
      return bluffmaster.random.arrayElement(bluffmaster.definitions.address.country_code_alpha_3);
    }
  ...
  this.state = function (useAbbr) {
    return bluffmaster.random.arrayElement(bluffmaster.definitions.address.state);
  }
  ...
  this.stateAbbr = function () {
    return bluffmaster.random.arrayElement(bluffmaster.definitions.address.state_abbr);
  }
  ...
  this.latitude = function (max, min, precision) {
    ...
    return bluffmaster.datatype.number({
      max: max,
      min: min,
  ...
  this.direction = function (useAbbr) {
    if (typeof useAbbr === 'undefined' || useAbbr === false) {
      return bluffmaster.random.arrayElement(bluffmaster.definitions.address.direction);
    }
    return bluffmaster.random.arrayElement(bluffmaster.definitions.address.direction_abbr);
  }
  ...
  this.cardinalDirection = function (useAbbr) {
    if (typeof useAbbr === 'undefined' || useAbbr === false) {
      return (
        bluffmaster.random.arrayElement(bluffmaster.definitions.address.direction.slice(0, 4))
      );
    }
    return (
      bluffmaster.random.arrayElement(bluffmaster.definitions.address.direction_abbr.slice(0, 4))
    );
  }
  ...
  this.ordinalDirection = function (useAbbr) {
    if (typeof useAbbr === 'undefined' || useAbbr === false) {
      return (
        bluffmaster.random.arrayElement(bluffmaster.definitions.address.direction.slice(4, 8))
      );
    }
    return (
      bluffmaster.random.arrayElement(bluffmaster.definitions.address.direction_abbr.slice(4, 8))
    );
  }
  ...
  this.timeZone = function() {
    return bluffmaster.random.arrayElement(bluffmaster.definitions.address.time_zone);
  }
