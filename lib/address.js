...
function Address(blaver) {
  ...
  this.zipCode = function (format) {
    ...
    if (typeof format === "undefined") {
      const localFormat = blaver.definitions.address.postcode;
      if (typeof localFormat === "string") {
        return Helpers.replaceSymbols(localFormat);

      } else {
        return Helpers.replaceSymbols(blaver.random.arrayElement(localFormat));
      }
    }
  ...
  this.streetSuffix = function () {
    return blaver.random.arrayElement(blaver.definitions.address.street_suffix);
  };
  ...
  this.streetPrefix = function () {
    return blaver.random.arrayElement(blaver.definitions.address.street_prefix);
  };
  ...
  this.secondaryAddress = function () {
    return Helpers.replaceSymbolWithNumber(blaver.random.arrayElement(["Apt. ###", "Suite ###"]));
  };
  ...
  this.county = function () {
    return blaver.random.arrayElement(blaver.definitions.address.county);
  };
  ...
  this.country = function () {
    return blaver.random.arrayElement(blaver.definitions.address.country);
  };
  ...
  this.countryCode = function (alphaCode) {
    if (typeof alphaCode === "undefined" || alphaCode === "alpha-2") {
      return blaver.random.arrayElement(blaver.definitions.address.country_code);
    }

    if (alphaCode === "alpha-3") {
      return blaver.random.arrayElement(blaver.definitions.address.country_code_alpha_3);
    }
   ...
   */
  this.state = function () {
    return blaver.random.arrayElement(blaver.definitions.address.state);
  };
  ...
  this.stateAbbr = function () {
    return blaver.random.arrayElement(blaver.definitions.address.state_abbr);
  };
  ...
  this.direction = function (useAbbr) {
    if (typeof useAbbr === "undefined" || useAbbr === false) {
      return blaver.random.arrayElement(blaver.definitions.address.direction);
    }

    return blaver.random.arrayElement(blaver.definitions.address.direction_abbr);
  };
  ...
  this.cardinalDirection = function (useAbbr) {
    if (typeof useAbbr === "undefined" || useAbbr === false) {
      return blaver.random.arrayElement(blaver.definitions.address.direction.slice(0, 4));
    }

    return blaver.random.arrayElement(blaver.definitions.address.direction_abbr.slice(0, 4));
  };
  ...
  this.ordinalDirection = function (useAbbr) {
    if (typeof useAbbr === "undefined" || useAbbr === false) {
      return blaver.random.arrayElement(blaver.definitions.address.direction.slice(4, 8));
    }

    return blaver.random.arrayElement(blaver.definitions.address.direction_abbr.slice(4, 8));
  };
  ...
  this.timeZone = function () {
    return blaver.random.arrayElement(blaver.definitions.address.time_zone);
  };
