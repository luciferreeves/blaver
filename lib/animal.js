...
var Animal = function (bluffmaster) {
  ...
  self.snake = function () {
    return bluffmaster.random.arrayElement(
      bluffmaster.definitions.animal.snake
    );
  };
  /**
   * bear
  ...
  self.cetacean = function () {
    return bluffmaster.random.arrayElement(
      bluffmaster.definitions.animal.cetacean
    );
  };
  /**
   * horse
  ...
  self.horse = function () {
    return bluffmaster.random.arrayElement(
      bluffmaster.definitions.animal.horse
    );
  };
  /**
   * bird
  ...
  self.crocodilia = function () {
    return bluffmaster.random.arrayElement(
      bluffmaster.definitions.animal.crocodilia
    );
  };
  /**
   * insect
  ...
  self.insect = function () {
    return bluffmaster.random.arrayElement(
      bluffmaster.definitions.animal.insect
    );
  };
  /**
   * rabbit
  ...
  self.rabbit = function () {
    return bluffmaster.random.arrayElement(
      bluffmaster.definitions.animal.rabbit
    );
  };
  /**
   * type
