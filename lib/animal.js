...
const Animal = function (blaver) {
   ...
   */
  this.snake = function () {
    return blaver.random.arrayElement(blaver.definitions.animal.snake);
  };
  ...
  this.cetacean = function () {
    return blaver.random.arrayElement(blaver.definitions.animal.cetacean);
  };
   ...
   */
  this.horse = function () {
    return blaver.random.arrayElement(blaver.definitions.animal.horse);
  };
  ...
  this.crocodilia = function () {
    return blaver.random.arrayElement(blaver.definitions.animal.crocodilia);
  };
  ...
  this.insect = function () {
    return blaver.random.arrayElement(blaver.definitions.animal.insect);
  };
  ...
  this.rabbit = function () {
    return blaver.random.arrayElement(blaver.definitions.animal.rabbit);
  };
