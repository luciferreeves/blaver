...
const Commerce = function (blaver) {
   ...
   */
  this.color = function () {
    return blaver.random.arrayElement(blaver.definitions.commerce.color);
  };
  ...
  this.department = function () {
    return blaver.random.arrayElement(blaver.definitions.commerce.department);
  };
  ...
  this.productAdjective = function () {
    return blaver.random.arrayElement(blaver.definitions.commerce.product_name.adjective);
  };
  ...
  this.productMaterial = function () {
    return blaver.random.arrayElement(blaver.definitions.commerce.product_name.material);
  };
  ...
  this.product = function () {
    return blaver.random.arrayElement(blaver.definitions.commerce.product_name.product);
  };
  ...
  this.productDescription = function () {
    return blaver.random.arrayElement(blaver.definitions.commerce.product_description);
  };
