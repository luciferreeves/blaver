...
var Commerce = function (bluffmaster) {
  ...
  self.color = function () {
    return bluffmaster.random.arrayElement(
      bluffmaster.definitions.commerce.color
    );
  };
  ...
  self.department = function () {
    return bluffmaster.random.arrayElement(
      bluffmaster.definitions.commerce.department
    );
  };
  ...
  self.productName = function () {
    return (
      bluffmaster.commerce.productAdjective() +
      " " +
  ...
  */
  ...
  self.productAdjective = function () {
    return bluffmaster.random.arrayElement(
      bluffmaster.definitions.commerce.product_name.adjective
    );
  };
  ...
  self.productMaterial = function () {
    return bluffmaster.random.arrayElement(
      bluffmaster.definitions.commerce.product_name.material
    );
  };
  ...
  self.product = function () {
    return bluffmaster.random.arrayElement(
      bluffmaster.definitions.commerce.product_name.product
    );
  };
  ...
  self.productDescription = function () {
    return bluffmaster.random.arrayElement(
      bluffmaster.definitions.commerce.product_description
    );
  };
