...
var Company = function (bluffmaster) {
  ...
  this.catchPhraseAdjective = function () {
    return bluffmaster.random.arrayElement(bluffmaster.definitions.company.adjective);
  }
  ...
  this.catchPhraseDescriptor = function () {
    return bluffmaster.random.arrayElement(bluffmaster.definitions.company.descriptor);
  }
  ...
  this.catchPhraseNoun = function () {
    return bluffmaster.random.arrayElement(bluffmaster.definitions.company.noun);
  }
  ...
  this.bsAdjective = function () {
    return bluffmaster.random.arrayElement(bluffmaster.definitions.company.bs_adjective);
  }
  ...
  this.bsBuzz = function () {
    return bluffmaster.random.arrayElement(bluffmaster.definitions.company.bs_verb);
  }
  ...
  this.bsNoun = function () {
    return bluffmaster.random.arrayElement(bluffmaster.definitions.company.bs_noun);
  }
