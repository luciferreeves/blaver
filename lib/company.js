...
const Company = function (blaver) {
  ...
  this.catchPhraseAdjective = function () {
    return blaver.random.arrayElement(blaver.definitions.company.adjective);
  };
  ...
  this.catchPhraseDescriptor = function () {
    return blaver.random.arrayElement(blaver.definitions.company.descriptor);
  };
  ...
  this.catchPhraseNoun = function () {
    return blaver.random.arrayElement(blaver.definitions.company.noun);
  };
  ...
  this.bsAdjective = function () {
    return blaver.random.arrayElement(blaver.definitions.company.bs_adjective);
  };
  ...
  this.bsBuzz = function () {
    return blaver.random.arrayElement(blaver.definitions.company.bs_verb);
  };
  ...
  this.bsNoun = function () {
    return blaver.random.arrayElement(blaver.definitions.company.bs_noun);
  };
};
