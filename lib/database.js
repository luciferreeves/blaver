...
var Database = function (bluffmaster) {
  ...
  self.column = function () {
    return bluffmaster.random.arrayElement(
      bluffmaster.definitions.database.column
    );
  };
  ...
  self.type = function () {
    return bluffmaster.random.arrayElement(
      bluffmaster.definitions.database.type
    );
  };
  ...
  self.collation = function () {
    return bluffmaster.random.arrayElement(
      bluffmaster.definitions.database.collation
    );
  };
  ...
  self.engine = function () {
    return bluffmaster.random.arrayElement(
      bluffmaster.definitions.database.engine
    );
  };
