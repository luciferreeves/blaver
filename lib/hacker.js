...
var Hacker = function (bluffmaster) {
  ...
  self.abbreviation = function () {
    return bluffmaster.random.arrayElement(bluffmaster.definitions.hacker.abbreviation);
  };
  ...
  self.adjective = function () {
    return bluffmaster.random.arrayElement(bluffmaster.definitions.hacker.adjective);
  };
  ...
  self.ingverb = function () {
    return bluffmaster.random.arrayElement(bluffmaster.definitions.hacker.ingverb);
  };
  ...
  self.phrase = function () {
    ...
    var phrase = bluffmaster.random.arrayElement(bluffmaster.definitions.hacker.phrase);
