...
const Hacker = function (blaver) {
  ...
  self.abbreviation = function () {
    return blaver.random.arrayElement(blaver.definitions.hacker.abbreviation);
  };
  ...
  self.adjective = function () {
    return blaver.random.arrayElement(blaver.definitions.hacker.adjective);
  };
  ...
  self.ingverb = function () {
    return blaver.random.arrayElement(blaver.definitions.hacker.ingverb);
  };
  ...
  self.phrase = function () {
    ...
    const phrase = blaver.random.arrayElement(blaver.definitions.hacker.phrase);
