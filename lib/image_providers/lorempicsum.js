 ...
 */
const LoremPicsum = function (bluffmaster) {
   ...
   * @method bluffmaster.image.lorempicsum.image
   ...
   * @param {number} height
   * @param {boolean} grayscale
   * @method bluffmaster.image.lorempicsum.imageGrayscaled
   ...
   * @param {number} height
   * @param {number} blur 1-10
   * @method bluffmaster.image.lorempicsum.imageBlurred
   ...
   * @param {number} blur 1-10
   * @param {string} seed
   * @method bluffmaster.image.lorempicsum.imageRandomSeeded
   ...
   * avatar
   *
   * @method bluffmaster.image.lorempicsum.avatar
   */
   ...
   * @param {number} blur 1-10
   * @param {string} seed
   * @method bluffmaster.image.lorempicsum.imageUrl
   */
