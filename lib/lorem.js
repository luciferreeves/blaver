...
const Lorem = function (blaver) {
   ...
   */
  this.sentences = function (sentenceCount, separator) {
   ...
   */
  this.paragraph = function (sentenceCount) {
    if (typeof sentenceCount == "undefined") {
      sentenceCount = 3;
    }
   ...
   * @param {string} separator defaults to `'\n \r'`
   */
  this.paragraphs = function (paragraphCount, separator) {
    if (typeof separator === "undefined") {
      separator = "\n \r";
    }
   ...
   */
  this.lines = function lines(lineCount) {
