...
const Phone = function (blaver) {
   ...
   */
  this.phoneNumber = function (format = blaver.phone.phoneFormats()) {
   ...
   * @memberOf blaver.phone
   */
  this.phoneNumberFormat = function (phoneFormatsArrayIndex = 0) {
    return blaver.helpers.replaceSymbolWithNumber(blaver.definitions.phone_number.formats[phoneFormatsArrayIndex]);
  };
