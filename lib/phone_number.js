...
var Phone = function (bluffmaster) {
  ...
  self.phoneNumberFormat = function (phoneFormatsArrayIndex) {
    ...
    return bluffmaster.helpers.replaceSymbolWithNumber(bluffmaster.definitions.phone_number.formats[phoneFormatsArrayIndex]);
  };
  ...
  self.phoneFormats = function () {
    return bluffmaster.random.arrayElement(bluffmaster.definitions.phone_number.formats);
  };
