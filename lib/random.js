...
function Random (bluffmaster, seed) {
  ...
  this.number = function (options) {
    console.log("Deprecation Warning: bluffmaster.random.number is now located in bluffmaster.datatype.number");
  ...
  this.float = function (options) {
    console.log("Deprecation Warning: bluffmaster.random.float is now located in bluffmaster.datatype.float");
  ...
  this.arrayElements = function (array, count) {
    ...
    while (i-- > min) {
      index = Math.floor((i + 1) * bluffmaster.datatype.float({ min: 0, max: 0.99 }));
   ...
   */
  this.uuid = function () {
    console.log("Deprecation Warning: bluffmaster.random.uuid is now located in bluffmaster.datatype.uuid");
  ...
  this.boolean = function () {
    console.log("Deprecation Warning: bluffmaster.random.boolean is now located in bluffmaster.datatype.boolean");
  ...
  this.hexaDecimal = function hexaDecimal(count) {
    console.log("Deprecation Warning: bluffmaster.random.hexaDecimal is now located in bluffmaster.datatype.hexaDecimal");
