...
var Vehicle = function (bluffmaster) {
  ...
  self.manufacturer = function () {
    return bluffmaster.random.arrayElement(
      bluffmaster.definitions.vehicle.manufacturer
    );
  };
  ...
  self.model = function () {
    return bluffmaster.random.arrayElement(
      bluffmaster.definitions.vehicle.model
    );
  };
  ...
  self.type = function () {
    return bluffmaster.random.arrayElement(
      bluffmaster.definitions.vehicle.type
    );
  };
  ...
  self.fuel = function () {
    return bluffmaster.random.arrayElement(
      bluffmaster.definitions.vehicle.fuel
    );
  };
  ...
  self.bicycle = function () {
    return bluffmaster.random.arrayElement(
      bluffmaster.definitions.vehicle.bicycle_type
    );
  };
