...
const Word = function (blaver) {
  ...
  this.conjunction = function (length) {
    ...
    if (length) {
      wordList = blaver.definitions.word.conjunction.filter(function(word) {
        return word.length === Number(length);
      });
    }
  ...
  this.interjection = function (length) {
    ...
    if (length) {
      wordList = blaver.definitions.word.interjection.filter(function (word) {
        return word.length === Number(length);
      });
    }
  ...
  this.preposition = function (length) {
    ...
    if (length) {
      wordList = blaver.definitions.word.preposition.filter(function (word) {
        return word.length === Number(length);
