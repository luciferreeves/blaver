...
var Word = function (bluffmaster) {
  ...
  self.conjunction = function (length) {
    ...
    if (length !== undefined) {
      length = parseInt(length);
      wordList = bluffmaster.definitions.word.conjunction.filter(function (
        word
      ) {
        return word.length == length;
      });
  ...
  self.interjection = function (length) {
    ...
    if (length !== undefined) {
      length = parseInt(length);
      wordList = bluffmaster.definitions.word.interjection.filter(function (
        word
      ) {
        return word.length == length;
      });
  ...
  self.preposition = function (length) {
    ...
    if (length !== undefined) {
      length = parseInt(length);
      wordList = bluffmaster.definitions.word.preposition.filter(function (
        word
      ) {
        return word.length == length;
      });
