...
describe("image.js", function () {
  describe("lorempicsum", function() {
    ...
    describe("avatar()", function () {
      it("return a random avatar from Pravatar", function () {
        assert.notStrictEqual(-1, bluffmaster.image.lorempicsum.avatar().indexOf('https://i.pravatar.cc'));
      })
    });
  ...
  describe("lorempixel", function() {
    ...
    describe("avatar()", function () {
      it("return a random avatar from Pravatar", function () {
        assert.notStrictEqual(-1, bluffmaster.image.lorempixel.avatar().indexOf('https://i.pravatar.cc'));
      })
    });
