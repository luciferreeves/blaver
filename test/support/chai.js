...
!(function (name, definition) {
  ...
  require.register("assertion.js", function (module, exports, require) {
    ...
    const AssertionError = require("./browser/error"),
    ...
    ["to", "be", "been", "is", "and", "have", "with"].forEach(function (chain) {
 ...
 */
    ...
    Assertion.prototype.property = function (name, val) {
      ...
      if (negate && undefined !== val) {
        if (undefined === value) {
          throw new Error(
            util.inspect(obj) + " has no " + descriptor + util.inspect(name)
          );
        }
      } else {
        this.assert(
    ...
    (function alias(name, as) {
      ...
      return alias;
    })("equal", "eq")("above", "gt")("below", "lt")("length", "lengthOf")(
      "keys",
      "key"
    )("ownProperty", "haveOwnProperty")("above", "greaterThan")(
      "below",
      "lessThan"
    )("Throw", "throws")("Throw", "throw")("instanceOf", "instanceof");
  }); // module: assertion.js
  ...
  require.register("chai.js", function (module, exports, require) {
    ...
    const expect = require("./interface/expect");
    exports.use(expect);
    ...
    const should = require("./interface/should");
    exports.use(should);
    ...
    const assert = require("./interface/assert");
    exports.use(assert);
  }); // module: chai.js
  ...
  require.register("interface/assert.js", function (module, exports, require) {
    ...
    module.exports = function (chai, util) {
       ...
       *
       *     const selection = { name: 'Chai', serve: 'with spices' };
  ...
  require.register(
    ...
    function (module, exports, require) {
       ...
       *
       *      const parsed = parsePath('myobject.property.subprop');
       *
       * ### Paths:
       *
       ...
       *
       *      const value = getPathValue(parsed, obj);
       *
  ...
  require.register(
    ...
    function (module, exports, require) {
       ...
       *
       *     const anotherAssertion = new Assertion(myObj);
